...
### Описание
Перейдите в класс [com.epam.training.student_Samvel_Danielyan.arrays.SumOfPrevious](src/main/java/com/epam/training/student_Samvel_Danielyan/arrays/SumOfPrevious.java) и реализуйте метод `getSumCheckArray`.
