...
Please, implement methods of class [`Triangle`](src/main/java/com/epam/training/student_Samvel_Danielyan/triangle/Triangle.java):
...
Class [`Point`](src/main/java/com/epam/training/student_Samvel_Danielyan/triangle/Point.java) is already there.
