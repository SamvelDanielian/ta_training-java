...
### Описание
Реализуйте следующие методы класса [`Segment`](src/main/java/com/epam/training/student_Samvel_Danielyan/segments/Segment.java): 
...
Класс [`Point`](src/main/java/com/epam/training/student_Samvel_Danielyan/segments/Point.java) уже существует. 
