...
Вам необходимо реализовать метод `intersection(Line)` в классе [`Line`](src/main/java/com/epam/training/student_Samvel_Danielyan/intersection/Line.java).
Он должен возвращать точку пересечения двух линий [`Point`](src/main/java/com/epam/training/student_Samvel_Danielyan/intersection/Point.java).
...
Вы можете проверить свой результат в классе [`Main`](src/main/java/com/epam/training/student_Samvel_Danielyan/intersection/Main.java).
