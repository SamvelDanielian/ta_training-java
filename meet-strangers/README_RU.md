...
Перейдите в класс [HelloStrangers](src/main/java/com/epam/training/student_Samvel_Danielyan/meetstrangers/HelloStrangers.java) и напишите простую программу, которая:
